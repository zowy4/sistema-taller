...
export function useOrdenesMutations() {
  ...
  const createMutation = useMutation({
    ...
    onError: (error: Error, _newOrden, context) => {
      ...
      if (error.message === 'FORBIDDEN') {
        toast.error('Sin permisos', { description: 'No tienes permisos para crear ó³rdenes' });
      } else {
  ...
  const updateMutation = useMutation({
    ...
    onError: (error: Error, _variables, context) => {
      ...
      if (error.message === 'FORBIDDEN') {
        toast.error('Sin permisos', { description: 'No tienes permisos para editar ó³rdenes' });
      } else {
